...
_TAG_STACK_PARAMETER = 'FlaskDockerTag'
...
def notify_slack(
    ...
    rollback = f'python frontend/release/deploy.py {previous_release}'
    slack_message = {
        'attachments': [{'fields': [{
            'title': 'Release Notes',
            'value': release_notes,
...
def main(string_args: Optional[Sequence[str]] = None) -> None:
    ...
    notify_slack(
        ...
        previous_release=previous_tag.removeprefix(_DOCKER_TAG_PREFIX))
