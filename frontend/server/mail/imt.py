...
def _make_months_section(months: Iterable['job_pb2.Month.V']) -> Optional[Dict[str, str]]:
    active_months = [
...
def _get_imt_vars(
    ...
    in_departement = geo.get_in_a_departement_text(database, departement_id, project.city)
...
campaign.register_campaign(campaign.Campaign(
    ...
    sender_name=i18n.make_translatable_string("Pascal et l'équipe de Bob"),
