...
_GOLDEN_FOCUS_CAMPAIGNS = (
    'christmas', 'focus-body-language', 'focus-network', 'focus-self-develop', 'focus-spontaneous',
    'galita-1', 'galita-2', 'galita-2-short', 'galita-3', 'galita-3-short', 'get-diploma',
    'get-diploma-short', 'improve-cv', 'imt', 'jobbing', 'jobbing-short', 'jobflix-invite',
    'network-plus', 'post-covid', 'prepare-your-application', 'prepare-your-application-short',
    'spontaneous-short', 'switch-grant',
)
