...
class _ImproveYourNetworkScoringModel(scoring.ModelBase):
...
scoring.register_model('advice-better-network', _ImproveYourNetworkScoringModel(2))
scoring.register_model('advice-improve-network', _ImproveYourNetworkScoringModel(1))
scoring.register_model('advice-use-good-network', _ImproveYourNetworkScoringModel(3))
