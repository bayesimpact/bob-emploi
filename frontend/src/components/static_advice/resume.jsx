...
class Page extends React.Component {
  render() {
    return <StaticAdvicePage
      adviceId={adviceId}
      title="Rendez votre CV plus percutant avec Bob">
      <AdviceSection
      ...
      <TestimonialStaticSection visualElement="improve-resume">
        <TestimonialCard
        ...
        <TestimonialCard
          author={{age: 29, jobName: 'Agente de voyages', name: 'Katia'}} isLong={true}>
        ...
        <TestimonialCard
          author={{age: 50, jobName: 'Coiffeuse', name: 'Nathalie'}} isLong={true}>
