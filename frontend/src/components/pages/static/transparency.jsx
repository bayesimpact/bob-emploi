...
import {ExternalLink, MAX_CONTENT_WIDTH, SmoothTransitions, Styles,
...
const userStats = {
  ...
  feedbackScores: [
    ...
    {name: 'Peu intéressants', value: .056},
    {color: colors.GREENISH_TEAL, name: 'Intéressants', value: .287},
    {color: colors.GREENISH_TEAL, name: 'Utiles', value: .287},
    {color: colors.GREENISH_TEAL, name: 'Très utiles', value: .32},
  ],
  // To get this number, update the dates and run the script analytics/manual/count_new_users.js
  totalUserCount: 137112,
  updatedAt: <span>au 1<sup>er</sup> mai 2018</span>,
}
