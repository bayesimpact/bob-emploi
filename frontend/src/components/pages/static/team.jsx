...
import alizeeImage from 'images/people/alizee.jpg'
...
const alizeeBio = {
  description: 'Alizée est spécialisée en marketing et gestion de communautés. \
    Avant de rejoindre Bayes Impact elle a travaillé chez Google Paris pendant 4 ans \
    dans des services commerciaux et marketing. Ses passions : explorer le \
    monde, faire du sport et aider à construire un monde meilleur.',
  education: "École Supérieure des Sciences Commerciales d'Angers, University of  Dayton",
  experience: 'Marketing et commercial chez Google, fondatrice de MeetHarry.co.',
  linkedin: 'https://www.linkedin.com/in/alizeebreton/',
  twitter: 'https://twitter.com/AlizeBreton',
}
...
const allPersons = [
  ...
  {bio: alizeeBio, name: 'Alizée Breton', picture: alizeeImage,
...
export default class TeamPage extends React.Component {
  ...
  render() {
    ...
    return <StaticPage
      style={{backgroundColor: '#fff', fontFamily: 'Lato, Helvetica'}}
      page="equipe" isNavBarTransparent={true} isContentScrollable={false}>
