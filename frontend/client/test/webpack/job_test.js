...
import {ApplicationMode} from 'api/job'
...
describe('genderizeJob', () => {
  it('should return an empty string for an undefined job', () => {
  ...
  it('should return an empty string for a job with no name', () => {
...
describe('getPEJobBoardURL', () => {
  it('should return a URL for pole-emploi job board', () => {
  ...
  it('should add specific query parameters if given', () => {
  ...
  it('should send to 1st arrondissement in Lyon', () => {
  ...
  it('should send to département in Paris', () => {
  ...
  it('should send to 1st arrondissement in Marseille, with larger radius', () => {
...
describe('getApplicationModes', () => {
  it('should return the application modes for a job group with one FAP', () => {
    const jobGroup = {applicationModes: {FAP: {modes: [
  ...
  it('should return the application modes for a job group with several FAPs', () => {
    const jobGroup = {applicationModes: {
      FAP: {modes: [
...
describe('getApplicationModeText', () => {
  Object.keys(ApplicationMode).map(mode =>
    ApplicationMode[mode] && it(`should return a non-empty string for ${mode}`, () =>
      expect(getApplicationModeText(mode)).to.not.be.empty))

  it('should return the same string for empty mode and 0 mode', () => {
    const zeroMode = Object.keys(ApplicationMode).find(mode => !ApplicationMode[mode])
    expect(getApplicationModeText('')).to.equal(getApplicationModeText(zeroMode))
  })
})
