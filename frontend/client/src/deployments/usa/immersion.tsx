...
const Email = (unusedProps: EmailProps): null => null

// TODO(émilie): DRY with UK content.
const content = 'A great way to learn about a job is to "shadow" someone who is already ' +
  'working in your target job.\n\n"Job shadowing" is when you spend time following a ' +
  ...
  'picture of what a job is like.\n\nWant to learn more? ' +
  'Here is an [article](https://www.thebalancecareers.com/what-is-job-shadowing-2062024' +
  'work-experience-and-internships/work-shadowing) with more information on job shadowing.'
