...
export default [
  {
    ...
    url: 'https://www.thersa.org/projects/archive/economy/future-work-awards/winners/bob-emploi',
  },
  {
    imageAltText: 'ACH',
    imageSrc: achImage,
    title: 'Bob UK the AI-powered job counsellor',
    url: 'https://ach.org.uk/news-and-features/bob-uk-ai-powered-job-counsellor-ach-named-finalist-career-tech-challenge',
  },
  {
    imageAltText: 'Nesta',
    imageSrc: nestaImage,
    title: 'Supporting the six million most at risk of losing their jobs in the next decade',
    url: 'https://media.nesta.org.uk/documents/Precarious_to_prepared._A_manifesto_for_supporting_the_six_million_most_at_risk_of_losing_their_jobs_in_the_next_decade_v5.pdf',
  },
  {
    imageAltText: 'Medium',
