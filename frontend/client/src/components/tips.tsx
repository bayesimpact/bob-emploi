...
const TipsListBase = (props: TipsListProps): React.ReactElement => {
    ...
    <VisibilitySensor
      ...
      <div>
        {tipsShown.map((tip): React.ReactNode => <AppearingComponent key={tip.actionId}><Action
          ...
          onOpen={handleOpenTip} /></AppearingComponent>)}
...
TipsListBase.propTypes = {
  advice: PropTypes.object.isRequired,
  project: PropTypes.object.isRequired,
  style: PropTypes.object,
}
const TipsList = React.memo(TipsListBase)
