...
class ContributionPageBase extends React.PureComponent<{dispatch: DispatchAllActions}> {
  private renderHowto(): React.ReactNode {
    return <React.Fragment>
      ...
      <ShareButtons campaign="cb" dispatch={this.props.dispatch} />
...
export default connect()(ContributionPageBase)
