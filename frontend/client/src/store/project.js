...
function newProject(newProjectData, gender) {
  return {
    ..._omit(newProjectData, ['projectId', 'createdAt', 'isIncomplete']),
...
// TODO(cyrille): Drop eslint disabling once https://github.com/eslint/eslint/pull/11158 is merged.
const flattenProject = projectFields => ({
  city: null,
  employmentTypes: ['CDI'],
  kind: null,
  minSalary: null,
