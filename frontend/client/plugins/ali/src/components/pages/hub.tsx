...
type HubCardProps = Omit<HubCardOwnProps, 'questions'|'topic'> & HubCardConnectedProps
...
const HubCardBase: React.FC<HubCardProps> = (props: HubCardProps): React.ReactElement => {
  ...
  const borderStyle = useMemo((): React.CSSProperties => ({
    ...
    transition: '450ms',
    zIndex: 4,
  }), [cardStyle.borderRadius, isHighlighted])
  ...
  return <Link {...handlers} style={cardStyle} to={linkTo}>
