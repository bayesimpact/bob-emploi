...
import {
  upskillingSectionsPost, upskillingSectionsMoreJobPost, upskillingSaveUser,
...
export const actionTypesToLog: {[action in AllUpskillingActions['type']]?: string} = {
  ...
  SEND_UPSKILLING_FEEDBACK_VOLUNTEERING: 'Send feedback volunteering',
  ...
  return (dispatch, getState): Promise<readonly bayes.upskilling.Section[]|void> => {
    ...
    return dispatch(wrapAsyncAction(
      ...
      async (): Promise<readonly bayes.upskilling.Section[]> => {
        ...
        return [
          ...config.hasOCR && !config.hasFeedbackBanner ? [ocrSection] : [],
          ...serverSections,
        ]
      },
      {departementId},
...
type SendUpskillingFeedbackVolunteeringAction = AsyncAction<
'SEND_UPSKILLING_FEEDBACK_VOLUNTEERING', unknown|void>

function sendUpskillingFeedbackVolunteering(email: string): ThunkAction<
Promise<unknown|void>, unknown, unknown, SendUpskillingFeedbackVolunteeringAction> {
  return wrapAsyncAction(
    'SEND_UPSKILLING_FEEDBACK_VOLUNTEERING', (): Promise<unknown|string> =>
      feedbackVolunteeringSend(email, 'Jobflix'))
}
...
export type AllUpskillingActions =
  ...
  | SendUpskillingFeedbackVolunteeringAction
...
export type DispatchAllUpskillingActions =
  ...
  ThunkDispatch<RootState, unknown, SendUpskillingFeedbackVolunteeringAction> &
...
export {
  ...
  sendUpskillingFeedbackVolunteering,
  setCityUpskillingAction,
  setLocalUser,
  setLocalUserLocale,
  showMoreInfo,
