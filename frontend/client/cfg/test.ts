  ...
  return {
    ...
    plugins: [
      new webpack.DefinePlugin({
        ...
        'config.externalLmiUrl': '"https://candidat.pole-emploi.fr/marche-du-travail/statistiques?codeMetier={{codeOgr}}&codeZoneGeographique={{departementId}}&typeZoneGeographique=DEPARTEMENT"',
