...
class ReferrerPolicy:
    ...
    def stripped_referrer(self, url: Any) -> Any: ...
    def origin_referrer(self, url: Any) -> Any: ...
    def strip_url(self, url: Any, origin_only: bool = ...) -> Any: ...
    def origin(self, url: Any) -> Any: ...
    def potentially_trustworthy(self, url: Any) -> Any: ...
    def tls_protected(self, url: Any) -> Any: ...
...
class NoReferrerWhenDowngradePolicy(ReferrerPolicy):
    name: Any = ...
    def referrer(self, response_url: Any, request_url: Any) -> Any: ...
...
class RefererMiddleware:
    ...
    def policy(self, resp_or_url: Any, request: Any) -> Any: ...
