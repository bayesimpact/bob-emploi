...
class ExecutionEngine:
    ...
    def spider_is_idle(self, spider: Any) -> Any: ...
    @property
    def open_spiders(self) -> Any: ...
    def has_capacity(self) -> Any: ...
    def crawl(self, request: Any, spider: Any) -> None: ...
    def schedule(self, request: Any, spider: Any) -> None: ...
    def download(self, request: Any, spider: Any) -> Any: ...
    def open_spider(self, spider: Any, start_requests: Any = ..., close_if_idle: bool = ...) -> None: ...
    def close_spider(self, spider: Any, reason: str = ...) -> Any: ...
