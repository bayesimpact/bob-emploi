...
class FSFilesStore:
    ...
    def stat_file(self, path: Any, info: Any) -> Any: ...
...
class S3FilesStore:
    ...
    def stat_file(self, path: Any, info: Any) -> Any: ...
    def persist_file(self, path: Any, buf: Any, info: Any, meta: Optional[Any] = ..., headers: Optional[Any] = ...) -> Any: ...
...
class FilesPipeline(MediaPipeline):
    ...
    def media_to_download(self, request: Any, info: Any) -> Any: ...
