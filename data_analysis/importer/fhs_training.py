...
_JobseekerCriteria = collections.namedtuple('JobseekerCriteria', [
    ...
    'unemployment_begin_date',
    'unemployment_end_date',
    'num_training',
    'training_info',
    'training_objective',
    'training_level',
...
def job_seeker_rows(job_seeker, now):
    ...
    for training in trainings:
        yield _JobseekerCriteria(
            ...
            training_info=training.get('FORMACOD'),
            training_objective=training.get('OBJFORM'),
            training_level=training.get('P2NIVFOR'),
            training_begin_date=training.get('P2DATDEB'),
            training_end_date=training.get('P2DATFIN'),
        )
