...
def fhs2dicts(durations_csv):
    ...
    """
    durations = _local_durations(durations_csv)[[
...
def _local_durations(durations_csv):
    ...
    _augment_cities(job_seekers, 'city_id')
...
def _augment_cities(job_seekers, city_field):
    ...
    """
    french_cities = cleaned_data.french_cities(unique=True)
