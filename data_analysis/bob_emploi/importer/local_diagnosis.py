...
def csv2dicts(
        ...
        job_offers_changes_json, job_imt_json, mobility_csv):
    ...
    less_stressful = _get_less_stressful_job_groups(mobility_csv, job_imt_json)
...
def _get_less_stressful_job_groups(mobility_csv, job_imt_json):
    mobility = cleaned_data.rome_job_groups_mobility(filename=mobility_csv)
