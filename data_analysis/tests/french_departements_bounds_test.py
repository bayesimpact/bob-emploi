...
from bob_emploi import french_departements_bounds
...
class FrenchDepartementsBoundsTestCase(unittest.TestCase):
    ...
    def test_basic_usage(self):
        ...
        # Spot checks.
        self.assertAlmostEqual(4.91667, bounds.loc['01', 'max_longitude'])
        self.assertAlmostEqual(4.83333, bounds.loc['01', 'min_longitude'])
        self.assertAlmostEqual(46.2333, bounds.loc['03', 'max_latitude'])
